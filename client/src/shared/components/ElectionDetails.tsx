                    ...
                    <section className="election-details-section">
                        ...
                        {voterCanRegister ? (
                            <div className="election-voter-actions">
                                ...
                                >
                                    {workflowBusy === "register"
                                        ? t("vote.registering", { defaultValue: "Registering identity..." })
                                        : registration?.commitmentStatus === "ON_CHAIN"
                                          ? t("vote.refreshRegistration", { defaultValue: "Refresh registration" })
                                          : t("vote.registerAction", { defaultValue: "Register to vote" })}
                                </button>
                            </div>
                        ) : null}
                        ...
                        {!voterCanRegister && election.phase === "REGISTRATION" && registration?.commitmentStatus === "ON_CHAIN" ? (
                            <div className="election-details-banner">
