...
public class SyncRequestAuthenticator
{
    ...
    public void verifySyncRequest(
            String timestampHeader,
            String signatureHeader,
            CitizenSyncRequest request
    )
    {
        if (request == null)
        {
            unauthorized("Invalid sync request");
        }
        ...
        {
            unauthorized("Invalid sync signature");
        }
    ...
    private long parseTimestamp(String timestampHeader)
    {
        ...
        {
            unauthorized("Missing sync timestamp");
        }
        ...
        {
            unauthorized("Invalid sync timestamp");
            return -1L;
        }
    }
    ...
    private byte[] parseSignature(String signatureHeader)
    {
        ...
        {
            unauthorized("Missing sync signature");
        }
    ...
    private byte[] sign(String payload)
    {
        ...
        {
            throw new IllegalStateException("Unable to verify sync signature", ex);
        }
    }
